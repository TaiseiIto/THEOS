...
enum ClassCode {
    ...
    HayesCompatibleModem16550Compatible,        // 07 03 01
    HayesCompatibleModem16650Compatible,        // 07 03 01
    HayesCompatibleModem16750Compatible,        // 07 03 01
    GPIB,                                       // 07 04 00
    SmartCard,                                  // 07 05 00
...
impl ClassCode {
    fn new(base_class: u8, sub_class: u8, programming_interface: u8) -> Self {
        match (base_class, sub_class, programming_interface) {
            (0, 0, 0) => Self::AllCurrentlyImplemented,
