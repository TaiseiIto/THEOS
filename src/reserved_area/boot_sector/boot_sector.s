...
# clister 0x06 : Data section
# ...
# clister 0xff : Data section

	.set	bytes_per_sector,	0x0200
	.set	sectors_per_cluster,	0x08
	.set	boot_sectors,		0x0020
	.set	fats,			0x02
	.set	root_directory_entries,	0x0100
	.set	sectors,		0x00000800	# The drive size = 1 MiB = 0x800 sectors * 0x0200 bytes
	.set	media_type,		0xf8
	.set	sectors_per_fat,	0x00000008
	.set	sectors_per_track,	0x0008
	.set	heads,			0x0002
	.set	hidden_sectors,		0x00000000
	.set	flags,			0x0000
	.set	fat_version,		0x0000
	.set	root_directory_cluster,	0x00000002
